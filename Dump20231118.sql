...
CREATE TABLE `alumnos` (
  ...
  KEY `fkAlumnoDatosAcademicos_idx` (`idDatoAcademico`) /*!80000 INVISIBLE */,
  KEY `fkAlumnoEstadoGeneral_idx` (`idEstadoGeneral`),
  KEY `fkTramites` (`idTramites`),
  KEY `fk_Tramite` (`idTramite`),
  CONSTRAINT `fk_Tramite` FOREIGN KEY (`idTramite`) REFERENCES `tramites` (`idtramite`),
...
INSERT INTO `alumnos` VALUES (1,'Pablo ','ESIME','PEGJ800515HJCNNS09','PEGJ800515XXX','5555','1','m','20-04-2000','mexicano','CMDX',1,1,1,1,1,1,'test1@gmail.com',1,1,20203000,'12345');
...
CREATE TABLE `asignaturas` (
  ...
  KEY `idx_Asignatura_id` (`idalumno`),
...
INSERT INTO `asignaturas` VALUES (1,'FISICA CLASICA','Carmen Flores',10.5,2,'FC1',1),(2,'CALCULO DIFERENCIAL E INTEGRAL ','Isabel Sánchez',12,2,'CDI1',1),(3,'FUNDAMENTOS DE ALGEBRA','Carlos López',6,1,'FA1',1),(4,'FUNDAMENTOS DE PROGRAMACION','Roberto Rodríguez',9,1,'FP1',1),(5,'HUMANIDADES I INGENIERIA CIENCIA Y SOCIEDAD','Sergio Díaz',9,1,'HICS1',1),(6,'QUIMICA BASICA','Gabriela Ramírez',7.5,1,'QB1',1);
...
CREATE TABLE `carreras` (
  ...
  CONSTRAINT `fk_Asignatura` FOREIGN KEY (`idAsignatura`) REFERENCES `asignaturas` (`idalumno`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `carreras` VALUES (1,'INGENIERIA EN COMUNICACIONES Y ELECTRONICA',465,77.5,33.21,9,14,1);
...
CREATE TABLE `datosacademicos` (
  ...
  `idKardex` int DEFAULT NULL,
  PRIMARY KEY (`id_dato_academico`),
  KEY `idDatosAcademicosCarrera_idx` (`idCarrera`) /*!80000 INVISIBLE */,
  KEY `fk_kardex` (`idKardex`),
  CONSTRAINT `fk_kardex` FOREIGN KEY (`idKardex`) REFERENCES `kardexes` (`idKardexs`),
...
INSERT INTO `datosacademicos` VALUES (1,20230311,1,1,9.8,1);
...
CREATE TABLE `kardexes` (
  ...
  `idKardexs` int DEFAULT NULL,
  PRIMARY KEY (`idKardex`),
  KEY `idKardexCarrera_idx` (`idCarrera`),
  KEY `idx_kardex_id` (`idKardexs`),
...
INSERT INTO `kardexes` VALUES (1,'C101',1,'FISICA CLASICA','2023-06-05','23/1','ORD',8,1),(2,'C102',1,'CALCULO DIFERENCIA E INTEGRAL','2023-06-05','23/1','ORD',6,1),(3,'C103',1,'FUNDAMENTOS DE ALGEBRA','2023-06-05','23/1','ORD',6,1),(4,'C104',1,'FUNDAMENTOS DE PROGRAMACION','2023-06-05','23/1','ORD',8,1),(5,'C105',1,'HUMANIDADES I INGENIERIA DE CIENCIAS Y SOCIALES','2023-06-05','23/1','ORD',9,1),(6,'C106',1,'QUIMICA BASICA','2023-06-05','23/1','ORD',9,1);
...
INSERT INTO `tramites` VALUES (1,20230010,'CONSTANCIA DE ESTUDIOS','2023-11-17','para dar de alta en el seguro ',1),(2,20203010,'CAMBIO DE HORARIO','2023-11-17','por cuestiones laborales',1);
...
-- Dump completed on 2023-11-18  0:04:44
