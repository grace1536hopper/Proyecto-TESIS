...
CREATE TABLE `alumnos` (
  ...
  KEY `fkAlumnoIngreso_idx` (`idIngreso`),
  ...
  CONSTRAINT `fkAlumnoIngreso` FOREIGN KEY (`idIngreso`) REFERENCES `ingresos` (`idIngreso`),
...
INSERT INTO `alumnos` VALUES (1,'Pablo ','ESIME','PEGJ800515HJCNNS09','PEGJ800515XXX','5555','1','m','20-04-2000','mexicano','CMDX',1,1,1,1,1,1,'test1@gmail.com','1234',1,'20200311',1);
...
INSERT INTO `ingresos` VALUES (1,20230030,'1235'),(2,20200311,'1234');
...
-- Dump completed on 2023-11-15 20:21:35
